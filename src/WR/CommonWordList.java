...
/**
 * Responsible for maintaining a list of the most commonly used words, also
 * known as `stop words`.
 * 
 * @author bc3soln
 */
public class CommonWordList {
	...
	private static final String[] stopWords = {
			...
			"asked",
			"asking", "asks", "at", "away", "b", "back", "backed",
			"backing",
			...
			"come",
			"could", "d", "did", "differ", "different", "differently", "do",
			"does",
			...
			"gives",
			"go", "going", "good", "goods", "got", "great", "greater",
			"greatest",
			...
			"i",
			"if", "important", "in", "interest", "interested",
			"interesting",
